	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-md-8">
	                <div class="content">
	                    <h3 class="d-none">
	                        Leading global <b>Company</b><br>
	                        to help you grow your business
	                    </h3>

	                    <p>
	                        Connect with us and see if there is a right-fit.
	                        Our mission and commitment is your business growth
	                        and success. We are your long-term partner!!
	                    </p>

	                    <p>
	                        GrowthBay is a Strategic Investment company that helps
	                        small businesses by providing investment funds,
	                        marketing capabilities and tools, and technology
	                        solutions critical for exponential growth and profitability today
	                    </p>
	            ...
	            <div class="row">
	                <div class="col-md-6">
	                    <div class="inBox">
	                        ...
	                        <h5>We are your long-term partner!!</h5>

	                        <p>
	                            Our approach is driven by long-term partnership,
	                            working directly with management teams at each company
	                            to identify opportunities unique to their business and
	                            provide resources and expertise to help them grow.
	                        </p>
	                    </div>
	                </div>
	...
	<section class="logosComp">
	    <div class="container">
	        ...
	        <div class="company slider slick-initialized slick-slider" data-sizes="50vw">
	            <div class="slick-list draggable">
	                <div class="slick-track" style="opacity: 1; width: 1110px; transform: translate3d(0px, 0px, 0px);">
	                    <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
	                        ...
	                        <div>
	                            <div style="width: 100%; display: inline-block;">
	                                <img class="" srcset="./images/customer-logo1.png" sizes="50vw"
	                                    src="./images/customer-logo1.png" style="opacity: 1;">
	                            </div>
	                        </div>
	                    </div>
	                    <div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false"
	                        ...
	                        <div>
	                            <div style="width: 100%; display: inline-block;">
	                                <img class="" srcset="./images/customer-logo2.png" sizes="50vw"
	                                    src="./images/customer-logo2.png" style="opacity: 1;">
	                            </div>
	                        </div>
	                    </div>
	                    <div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false"
	                        ...
	                        <div>
	                            <div style="width: 100%; display: inline-block;">
	                                <img class="" srcset="./images/customer-logo3.png" sizes="50vw"
	                                    src="./images/customer-logo3.png" style="opacity: 1;">
	                            </div>
	                        </div>
	                    </div>
	                    <div class="slick-slide slick-active" data-slick-index="3" aria-hidden="false"
	                        ...
	                        <div>
	                            <div style="width: 100%; display: inline-block;">
	                                <img class="" srcset="./images/customer-logo4.png" sizes="50vw"
	                                    src="./images/customer-logo4.png" style="opacity: 1;">
	                            </div>
	                        </div>
	                    </div>
	                    <div class="slick-slide slick-active" data-slick-index="4" aria-hidden="false"
	                        ...
	                        <div>
	                            <div style="width: 100%; display: inline-block;">
	                                <img class="" srcset="./images/customer-logo5.png" sizes="50vw"
	                                    src="./images/customer-logo5.png" style="opacity: 1;">
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="worthBox">
	                    <div class="wFlex">
	                        <div class="col-flex">
	                            ...
	                            <p>
	                                90% are leveraging our business
	                ...
	                <div class="worthBox">
	                    <div class="wFlex">
	                        <div class="col-flex">
	                            ...
	                            <p>
	                                80 % of our clients reported increasing revenue
	                                just 6 months after starting with us
	                            </p>
	                        </div>
	                ...
	                <div class="worthBox">
	                    <div class="wFlex">
	                        <div class="col-flex">
	                            ...
	                            <p>
	                                We provide a professional support network
	                                to our partners at no cost.
	                            </p>
	                        </div>
