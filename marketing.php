	...
	<section class="hero marketing d-none">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-8">
	                <div class="content">
	                    <h3> We offer Best <b>Marketing Solutions</b><br> to help you grow your business </h3>
	                    <a href="#" class="btn btn-heroLink"> Request a quote </a>
	                </div>
	            </div>
	        </div>
	    </div>
	...
	<section class="universal">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	                <div class="content">
	                    <h3 class="pr-3"> Unexpected Marketing Concepts... Discovered. let us help to grow your revenue
	                        exponentially </h3>
	                    <h4> GET MORE TRAFFIC,ACQUIRE MORE CUSTOMERS, SELL MORE .. WE ARE HERE TO HELP YOU THROUGH EVERY
	                        STEP OF THE WAY </h4>
	                    <p> At Growthbay, we unlock these unexpected marketing opportunities. Our unique collective
	                        backgrounds with non-traditional marketing give us the ability to solve marketing and business
	                        challenges in ways never before considered. As we partner with you, we always start by focusing
	                        on the underlying business objectives that drive the big picture. “What are you trying to
	                        achieve as a business?” is the first thing we ask before we dive too deep into a marketing
	                        conversation. We bring in our vast marketing expertise to get more organic traffic and
	                        exponentially increase revenue generation in your business. </p>
	                    <!-- <p>
							And unlike many agencies, we always start by focusing on the underlying 
							business objectives that drive the big picture. “What are you trying to 
							achieve as a business?” is the first thing we ask before we dive too 
							deep into a marketing conversation.
						</p>
						...
						<p class="d-none">
							Growthbay provides you eith the most relevant digital marketing 
							strategy or your type of business. Blending performance with 
							exceptional customer service, our PPC specialists are some of 
							the best in the industry with a track record for growing 
						...
						<p class="d-none">
							...
							most to your business. We achieve measurable results by working 
							on every variable that impacts SERPs. Trust our proven track 
							record to maximize your visibility online. Set your business 
							up for long-term success.
						</p> -->
	                    <a href="#" class="btn btn-request"> CONNECT WITH US </a>
	                </div>
	            </div>
	            <div class="col-md-6">
	                <!-- <figure>
	...
	<section class="universal bg">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	                <figure>
	                    <img src="images/marketing-content-img2.jpg" alt="">
	                </figure>
	            </div>
	            <div class="col-md-6">
	                <div class="content">
	                    <h4>Industry Expertise</h4>
	                    <p> Our innovative approach to marketing is driven by our knowledge of specific industries.
	                        Marketing a telecom product is completely different than marketing a store or small business.
	                        We specialize in the industries below and know what it takes to truly drive business for these
	                        companies. </p>
	                    <ul>
	                        <li>Retail</li>
	                        <li>Telecom</li>
	                    ...
	                    <a href="#" class="btn btn-request"> Learn more </a>
	                </div>
	            </div>
	        </div>
	    </div>
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-6">
	                <div class="leftBox">
	                    <figure>
	                        <img src="images/dahsboard-img2.png" alt="">
	                    </figure>
	                </div>
	            </div>
	            <div class="col-md-6">
	                <div class="content">
	                    <ul>
	                        <!-- <li> Tailored-made funding for your immediate and long-term business needs. </li>
	                        <li> Flexible Funding Options – Our process is short and adaptable to your unique business need
	                            and situations. </li>
	                        <li> Streamline and quick Funding Process; A streamline, secure process to meet your investment
	                            funding needs within 3 -6 months! </li>
	                        <li> Confidential business discussion through-out the process – Your business information are
	                            protected and secure </li>
	                        <li> Streamlined Communication: Our engagements and collaboration with you are streamlined to
	                            facilitate the funding process. </li> -->
								<li>We partner with industry marketing experts to grow your market audience and provide strategic marketing plans and insights for your specific business.</li>
								<li>We also provide fundings to carry out marketing plans and strategies through our partnership</li>
								<li>Confidential business discussion through-out the process – Your business information are protected and secure with us.</li>
	                    </ul>
	...
	<!-- <section class="common">
	    <div class="container">
	        ...
	        <p> Growthbay provides you with the most relevant digital marketing strategy or your type of business. Blending
	            performance with exceptional customer service, our PPC specialists are some of the best in the industry
	            with a track record for growing successful businesses </p>
	        <h4>Drive more organic traffic to your website.</h4>
	        <p> Get more qualified traffic on the search terms that matter most to your business. We achieve measurable
	...
	<section class="universal d-none">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	            ...
	            <div class="col-md-6">
	                <figure>
	                    <img src="images/marketing-content-img3.jpg" alt="">
	                </figure>
	            </div>
	        </div>
	    </div>
	...
	<section class="universal d-none">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	                <figure>
	                    <img src="images/marketing-content-img4.jpg" alt="">
	                </figure>
	            </div>
	            <div class="col-md-6">
	                <div class="content flex">
	                    <div class="inBox">
	                        <h4>Corporate Landing</h4>
	                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
	                            ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
	                            ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
	                            reprehenderit in voluptate velit esse cillum dolore </p>
	...
	<section class="universal d-none">
	    <div class="container">
	        <div class="row">
	            ...
	            <div class="col-md-6">
	                <figure>
	                    <img src="images/marketing-content-img5.jpg" alt="">
	                </figure>
	            </div>
	        </div>
	    </div>
	...
	<section class="universal d-none">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	                <figure>
	                    <img src="images/marketing-content-img6.jpg" alt="">
	                </figure>
	            </div>
	            <div class="col-md-6">
	                <div class="content flex">
	                    <div class="inBox">
	                        <h4>Retail and Private Banking</h4>
	                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
	                            ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
	                            ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
	                            reprehenderit in voluptate velit esse cillum dolore </p>
	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6">
	                <div class="content flex">
	                    <div class="inBox">
	                        <h4>Regulatory Risk and Compliance Reporting</h4>
	                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
	                            ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
	                            ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in
	                            reprehenderit in voluptate velit esse cillum dolore </p>
	            ...
	            <div class="col-md-6">
	                <figure>
	                    <img src="images/marketing-content-img7.jpg" alt="">
	                </figure>
	            </div>
	        </div>
	    </div>
	...
	<section class="logosComp d-none">
	    <div class="container">
	        <h3>Partners we bring on bord to your Business</h3>
	        ...
	        <a href="#" class="btn btn-logos "> SEE ALL Customers </a>
	    </div>
	</section>
	<section class="worth">
	    <div class="container">
	        <div class="row">
	                ...
	                <div class="worthBox">
	                    <div class="wFlex">
	                        <div class="col-flex">
	                            <h4> 4.1 million+ </h4>
	                            <hr class="dvdr">
	                            <p> users from all corners of the globe </p>
	                        </div>
	                        <div class="col-flex">
	                            <figure>
	            ...
	            <div class="col-md-4 blue">
	                <div class="worthBox">
	                    <div class="wFlex">
	                        <div class="col-flex">
	                            <h4> 10,000 M&A deals </h4>
	                            <hr class="dvdr">
	                            <p> are closed on SS&C Intralinks each year </p>
	                        </div>
	                        <div class="col-flex">
	                            <figure>
	            ...
	            <div class="col-md-4">
	                <div class="worthBox">
	                    <div class="wFlex">
	                        <div class="col-flex">
	                            <h4> $34.7 trillion worth </h4>
	                            <hr class="dvdr">
	                            <p> of financial transactions </p>
	                        </div>
	                        <div class="col-flex">
	                            <figure>
	...
	<section class="location d-none">
	    <div class="container">
	        <div class="boxTop">
	            <div class="row">
	                <div class="col-md-12">
	                    ...
	                    <p> Our mode of operation is dynamic and we are always steps ahead of the ordinary </p>
	                </div>
	            </div>
	        </div>
	        <div class="inbox">
	            <div class="row">
	                <div class="col-md-4">
	                    <div class="serBox">
	                        <figure>
	                            <img src="images/gb-service-icon4.png" alt="">
	                        </figure>
	                ...
	                <div class="col-md-4">
	                    <div class="serBox">
	                        <figure>
	                            <img src="images/gb-service-icon5.png" alt="">
	                        </figure>
	                        <h4> Good Reviews<br> From Past Customers </h4>
	                    </div>
	                </div>
	                <div class="col-md-4">
	                    <div class="serBox">
	                        <figure>
	                            <img src="images/gb-service-icon6.png" alt="">
	                        </figure>
	                        <h4> Professional<br> consultation team </h4>
	                    </div>
	                </div>
	            </div>
	        </div>
	        ...
	        <br>
	        <br>
	        <div class="boxTop" style="margin-bottom: 0px;">
	            <div class="row">
	                <div class="col-md-12">
	                    <h5> We're Ready to Get Started </h5>
	...
	<section class="GrowthBay d-none">
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-4">
	                <div class="gbBox new">
	                    ...
	                    <div class="gbBtnBox">
	                        <a href="#" class="btn btngbLink"> Webinar </a>
	                    </div>
	                    <div class="gbContent">
	                        <h4> Webinar on How to expand into Europe </h4>
	            ...
	            <div class="col-md-4">
	                <div class="gbBox">
	                    ...
	                    <div class="gbBtnBox">
	                        <a href="#" class="btn btngbLink orange"> Virtual Event </a>
	                    </div>
	                    <div class="gbContent">
	                        <h4> Forbes/ EY Small Business Webinar </h4>
	            ...
	            <div class="col-md-4">
	                <div class="gbBox">
	                    ...
	                    <div class="gbBtnBox">
	                        <a href="#" class="btn btngbLink purple"> Service Update </a>
	                    </div>
	                    <div class="gbContent">
	                        <h4> Technology update from Uipath </h4>
	        ...
	        <br>
	        <p class="textBottom d-none"> Scroll for Knowledge Base, Market Insights, Partners Proposals/Free Bees </p>
	    </div>
	</section>
	<section class="connect d-none">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-4">
	                <h3> More than two decades after pioneering the virtual data room, we’re still the leading innovator in
	                    financial technology, trusted by more than 99% of the Fortune 1000. </h3>
	                <a href="#" class="btn btn-connect"> See All Products </a>
	            </div>
	            <div class="col-md-8">
	                <div class="row">
	                    <div class="col-md-4">
	                        <div class="cnBox">
	                            ...
	                            <h4> Funding & Investment Solutions for your business </h4>
	                        </div>
	                    </div>
	                    <div class="col-md-4">
	                        <div class="cnBox">
	                            ...
	                            <h4> Marketing Solution for your business </h4>
	                        </div>
	                    </div>
	                    <div class="col-md-4">
	                        <div class="cnBox">
	                            ...
	                            <h4> Automation & Technology Solutions for your Business </h4>
	                        </div>
	                    </div>
	                </div>
	            </div>
	                ...
	                <div class="row">
	                    <div class="col-md-4">
	                        <div class="infoBox">
	                            ...
	                            <div class="title">
	                                <h3> Submit your Expression of Interest (EOI). </h3>
	                            </div>
	                            <div class="imagBox">
	                                <figure>
	                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
	                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="440.001px"
	                                        height="440.001px" viewBox="0 0 440.001 440.001"
	                                        style="enable-background:new 0 0 440.001 440.001;" xml:space="preserve">
	                                        <g>
	                                            <g>
	                                                <g>
	                                                    <path fill="#20bf55" d="M439.213,382.709l-27.329-109.314c-0.425-1.705-1.093-3.297-1.94-4.76c1.562-4.334,2.42-9.004,2.42-13.869V74.571
	                                                    ...
	                                                    <path fill="#20bf55" d="M229.972,157.081l11.472-3.129c2.271-0.619,3.889-2.631,4-4.984c0.114-2.353-1.302-4.511-3.502-5.346l-52.898-20.064
	                            ...
	                            <div class="desc">
	                                <p> Enter Your information in the web form above. </p>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-md-4">
	                        <div class="infoBox">
	                            ...
	                            <div class="title">
	                                <h3> Initial Call to discuss your Business request and Growth Vision. </h3>
	                            </div>
	                            <div class="imagBox">
	                                <figure>
	                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
	                                        ...
	                                        xml:space="preserve">
	                                        <g id="XMLID_7_">
	                                            <path fill="#20bf55" id="XMLID_8_" d="M275.445,135.123c0.387-45.398-38.279-87.016-86.192-92.771c-0.953-0.113-1.991-0.285-3.09-0.467
													c-2.372-0.393-4.825-0.797-7.3-0.797c-9.82,0-12.445,6.898-13.136,11.012c-0.672,4-0.031,7.359,1.902,9.988
													c3.252,4.422,8.974,5.207,13.57,5.836c1.347,0.186,2.618,0.359,3.682,0.598c43.048,9.619,57.543,24.742,64.627,67.424
													c0.173,1.043,0.251,2.328,0.334,3.691c0.309,5.102,0.953,15.717,12.365,15.717h0.001c0.95,0,1.971-0.082,3.034-0.244
													c10.627-1.615,10.294-11.318,10.134-15.98c-0.045-1.313-0.088-2.555,0.023-3.381C275.429,135.541,275.444,135.332,275.445,135.123z
													" />
	                                            <path fill="#20bf55" id="XMLID_9_"
	                                            ...
	                                            <path fill="#20bf55" id="XMLID_10_" d="M288.36,233.703c-1.503-1.148-3.057-2.336-4.512-3.508c-7.718-6.211-15.929-11.936-23.87-17.473
	                                            ...
	                                            <path fill="#20bf55" id="XMLID_11_" d="M186.687,83.564c-4.107,0.104-12.654,0.316-15.653,9.021c-1.403,4.068-1.235,7.6,0.5,10.498
	                            ...
	                            <div class="desc">
	                                <p> You will be contacted to discuss your business request and our Offer framework.
	                                </p>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-md-4">
	                        <div class="infoBox">
	                            ...
	                            <div class="title">
	                                <h3> Business Management Meetings to Agree Growth plan. </h3>
	                            </div>
	                            <div class="imagBox">
	                                <figure>
	                                    <svg id="bold" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24"
	                                        ...
	                                        <circle fill="#20bf55" cx="4" cy="15" r="2" />
	                                        <path fill="#20bf55"
	                            ...
	                            <div class="desc">
	                                <p> This will also include Document exchange, Legal protections (NDAs), and involvement
	                                    of GrowthBay partners. </p>
	                            </div>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="infoBox">
	                            ...
	                            <div class="imagBox">
	                                <figure>
	                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
	                                        ...
	                                        <g>
	                                            <g>
	                                                <path fill="#20bf55" d="M504.501,187.277c-4.143,0-7.5,3.357-7.5,7.5v18.475c0,7.984-6.496,14.481-14.481,14.481
	                                        ...
	                                        <g>
	                                            <g>
	                                                <path fill="#20bf55" d="M257.164,314.486c18.377-16.594,6.669-47.322-18.188-47.322h-50.598c17.674-32.319,16.502-64.987,16.295-68.818
	                            ...
	                            <div class="desc">
	                                <p> This will include Deal Structuring, Due-diligence, and Negotiations. </p>
	                            </div>
	                        </div>
	                    </div>
	                    <div class="col-md-6">
	                        <div class="infoBox">
	                            ...
	                            <div class="title">
	                                <h3> Fund Disbursement & Strategic Investment in your business </h3>
	                            </div>
	                            <div class="imagBox">
	                                <figure>
	        ...
	        <div class="row">
	            <div class="col-md-4">
	                <div class="preBox">
	                    ...
	                    <hr>
	                    <p> In Business more than 12 months </p>
	                </div>
	            </div>
	            <div class="col-md-4">
	                <div class="preBox">
	                    ...
	                    <hr>
	                    <p> Sales more than $10K per month </p>
	                </div>
	            </div>
	            <div class="col-md-4">
	                <div class="preBox">
	                    ...
	                    <hr>
	                    <p> Founders’ commitment to business growth </p>
	                </div>
	            </div>
	        </div>
	    </div>
	...
	<section class="partner d-none">
	    <div class="container">
	        <div class="partnerBox">
	            <h3> Partner of Choice for small businesses seeking national and international Markets </h3>
	            <p> we can bring our partners and alliance network to get you new businesses </p>
	            <a href="#" class="btn btn-contact"> CONTACT US </a>
	        </div>
	        <div class="pbBox">
	            <div class="row">
	                <div class="col-md-4">
	                    <div class="leftBox">
	                        <h4>Safer.</h4>
	                        <p> Share with confidence and compliance. </p>
	                    </div>
	                    <div class="leftBox">
	                        <h4>Simpler.</h4>
	                        <p> Focus on your deal, not the technology. </p>
	                    </div>
	                    <div class="leftBox">
	                        <h4>Smarter.</h4>
	                        <p> Save timeand avoid costly errors. </p>
	                    </div>
	                </div>
	                <div class="col-md-8">
	                    <div class="rightBox">
	        ...
	        <div class="row">
	            <div class="col-md-4">
	                <div class="focus-box">
	                    ...
	                    <h4> Focus on your business goals </h4>
	                </div>
	            </div>
	            <div class="col-md-4">
	                <div class="focus-box">
	            ...
	            <div class="col-md-4">
	                <div class="focus-box">
	                    ...
	                    <h4> Compliant with Local and Business ethics, contracts etc </h4>
	                </div>
	            </div>
	        </div>
	    </div>
	...
	<section class="idsGroup d-none">
	    <div class="container">
	        <div class="idsContent">
	            <h3> Interlynks Dedicated Services Group </h3>
	            <p> Expert help, with a personal touch. On call anytime, any place, in 140 languages. </p>
	            <a href="#" class="btn btn-explore"> EXPLORE YOUR OPTIONS </a>
	        </div>
	        ...
	        <div class="row">
	            <div class="col-md-3">
	                <div class="insightBox">
	                    ...
	                    <div class="contentBox">
	                        <h3> How Top M&A Professionals Are Embracing ESG in the Deal Process </h3>
	                        <h4> WHITE PAPER </h4>
	                    </div>
	                </div>
	            </div>
	            ...
	            <div class="col-md-3">
	                <div class="insightBox">
	                    ...
	                    <div class="contentBox">
	                        <h3> Asia-Pacific M&A Activity Remains Dynamic After A Strong Start to the Year </h3>
	                    </div>
	                </div>
	            </div>
	            <div class="col-md-3">
	                <div class="insightBox">
	                    ...
	                    <div class="contentBox">
	                        <h3> SS&C Intralinks Deal Flow Predictor for Q3 2021 </h3>
	                        <h4> Publication </h4>
	                    </div>
	                </div>
	            </div>
	        </div>
	        <a href="#" class="btn btn-insights"> see all insights </a>
	    </div>
	</section> <?php
