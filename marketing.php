		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<div class="content">
						<h3>
							We offer Best <b>Marketing Solutions</b><br>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="content">
						...
						<h4>
							GET MORE TRAFFIC,ACQUIRE MORE CUSTOMERS, SELL MORE ..
							WE ARE HERE TO HELP YOU THROUGH EVERY STEP OF THE WAY
						</h4>

						<p>
							At Growthbay, we unlock these unexpected marketing opportunities. 
							Our unique collective backgrounds with non-traditional marketing 
							give us the ability to solve marketing and business challenges in 
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="content">
						...
						<p>
							Our innovative approach to marketing is driven by our 
							knowledge of specific industries. Marketing a telecom 
							product is completely different than marketing a store 
							or small business. We specialize in the industries below 
							and know what it takes to truly drive business for 
							these companies.
						</p>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="content">
						<ul>
							<li>
								Tailored-made funding for your immediate and long-term business needs.
							</li>

							<li>
								Flexible Funding Options – Our process is short and adaptable to your unique business need and situations.
							</li>

							<li>
								Streamline and quick Funding Process; A streamline, secure process to meet your investment funding needs within 3 -6 months!
							</li>

							<li>
								Confidential business discussion through-out the process – Your business information are protected and secure
							</li>

							<li>
								Streamlined Communication: Our engagements and collaboration with you are streamlined to facilitate the funding process.
							</li>
						</ul>
	...
	<section class="common">
		<div class="container">
			...
			<p>
				Growthbay provides you with the most relevant digital marketing 
				strategy or your type of business. Blending performance with exceptional 
				customer service, our PPC specialists are some of the best in the 
