	            ...
	            <div class="col-md-6">
	                <div class="content">
	                    <div class="inBox">
	                        ...
	                        <p>
	                            <li>Accelerate revenue growth through tech-enabled systems required for your specific
	                                industry. </li>
	                            <li>Continuously adapt and respond to the changing digital, technological, and analytics
	                                landscape.</li>
	                            <li>Build strategic road map and scaling the necessary changes for a tech enabled business
	                                transformation -Provide the flexibility your business needs to excel across all
	                                value-creation levers of the commercial function.</li>
	                            <li>
	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-md-6 mb-5">
	                <figure>
	                    <img class="img-fluid" src="images/technology-img.png" alt="">
	                </figure>
	            </div>
	            <div class="col-md-6">
