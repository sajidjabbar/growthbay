	...
	<section class="hero funding d-none">
	    <div class="container">
	        <div class="row">
	            <div class="col-md-8">
	                <div class="content">
	                    <h3>
	                        We Provide <b>Funding Opportunities</b><br>
	...
	<section class="fundingPortfolio d-none">
	    ...
	    <div class="inBox random">
	        <div class="tabsList">
	            <div class="container">
	                <!-- Nav tabs -->
	                <ul class="nav nav-tabs">
	                    <li class="nav-item">
	                        <a class="nav-link active" data-toggle="tab" href="#fundTab1">Funding Solutions</a>
	                    </li>

	                    <li class="nav-item">
	                        <a class="nav-link" data-toggle="tab" href="#fundTab2">Flexible Funding Options </a>
	                    </li>

	                    <li class="nav-item">
	                        <a class="nav-link" data-toggle="tab" href="#fundTab3">Quick Funding Process</a>
	                    </li>

	                    <li class="nav-item">
	                        <a class="nav-link" data-toggle="tab" href="#fundTab4">Reasonable Terms and Conditions</a>
	                    </li>
	                </ul>
	            </div>
	        </div>
	        ...
	        <div class="tabsBox ">
	            <div class="container">
	                ...
	                <div class="tab-content">
	                    <div class="tab-pane container active" id="fundTab1">
	                        <div class="tabFull">
	                            <h4>Technology solutions across your entire fund.</h4>
	                        </div>
	                    </div>

	                    <div class="tab-pane container fade" id="fundTab2">
	                        <div class="tabFull">
	                            <h4>Technology solutions across your entire fund.</h4>
	                        </div>
	                    </div>

	                    <div class="tab-pane container fade" id="fundTab3">
	                        <div class="tabFull">
	                            <h4>Technology solutions across your entire fund.</h4>
	                        </div>
	                    </div>

	                    <div class="tab-pane container fade" id="fundTab4">
	                        <div class="tabFull">
	                            <h4>Technology solutions across your entire fund.</h4>
	                        </div>
	                    </div>
	            ...
	            <div class="col-md-6">
	                <div class="content">
	                    <div class="inbox">
	                        ...
	                        <!--
								<p>
									We are Strategic Investors, together with our private equity and institutional 
									partners. We believe that small businesses deserve a best-in-class business 
									partner to provide leverage and differentiation from the competition as they 
									work to achieve their goals. For small businesses that qualify, we are committed 
									to long-term fund injection into your business for growth.
								</p>

								<p>
									Growth bay is committed to helping businesses augment their competitive 
									advantages to expand cash flow and increase customer base. Our SME partners have 
									recorded higher revenues which in turn led to job creation in their local communities. 
									They have leveraged our partnership for a strong ability to generate cash, have 
									significant competitive advantages, and fundamental utility to customers.
								</p>

								<p>
									This is funding at your fingertips – not just a loan but long-term investment in your 
									vision for your business by a strategic investor.
								</p>

								<p>
									Join the largest finance solution community for small businesses. 
								</p>

								<p>
									Watch the short clip and learn more about our innovative funding solutions.
								</p>
							-->
	                    ...
	                    <div class="tab-pane container active" id="fundTab1">
	                        <div class="tabFull">
	                            ...
	                            <div class="text-center">
	                                <img src="images/tech-img1.png" class="img-fluid" alt="">
	                            </div>
	                            <!-- </figure> -->
	                        </div>
	                    </div>
	            ...
	            <div class="col-md-6">
	                <div class="content">
	                    ...
	                    <ul>
	                        ...
	                        <li>
	                            Quick Funding Process; A streamline, secure process to meet your investment funding needs
	                            within 3 -6 months!
	                        </li>
	                    ...
	                    <p>Growthbay remains committed to helping our various partners get the right funding.</p>
	...
	<section class="quote d-none">
	    <div class="container">
	        ...
	        <h3>
	            No Ordinary Business Strategy Consulting
	        </h3>

	        <p>
	            Jay has spent his entire career helping executives solve problems and fix business. His unique approach to
	            business
	            strategy consulting has significantly increased the bottom lines of over 10,000 clients worldwide. He has
	    ...
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-md-3">
	                <div class="termBox">
	                    <div class="imgBox">
	                        <figure class="p-3 rounded-circle pr-color">
	                            <img
	                                src="https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/45/ffffff/external-calendar-interface-kiranshastry-lineal-kiranshastry-4.png" />
	                            <!-- <img src="images/term-ico1.jpg" alt=""> -->
	                        </figure>
	                    </div>
	            ...
	            <div class="col-md-3">
	                <div class="termBox">
	                    <div class="imgBox">
	                        <figure class="p-3 rounded-circle pr-color">
	                            <img src="https://img.icons8.com/dotty/45/ffffff/home.png" />
	                            <!-- <img src="images/term-ico1.jpg" alt=""> -->
	                        </figure>
	                        <!-- <figure>
	                            <img src="images/term-ico2.jpg" alt="">
	                        </figure> -->
	                    </div>
	            ...
	            <div class="col-md-3">
	                <div class="termBox">
	                    <div class="imgBox">
	                        <figure class="p-3 rounded-circle pr-color">
	                            <img src="https://img.icons8.com/ios/50/ffffff/positive-dynamic.png" />
	                            <!-- <img src="images/term-ico1.jpg" alt=""> -->
	                        </figure>

	                        <!-- <figure>
	                            <img src="images/term-ico3.jpg" alt="">
	                        </figure> -->
	                    </div>
	            ...
	            <div class="col-md-3">
	                <div class="termBox">
	                    <div class="imgBox">
	                        <figure class="p-3 rounded-circle pr-color">
	                            <img
	                                src="https://img.icons8.com/external-itim2101-lineal-itim2101/50/ffffff/external-support-contact-and-message-itim2101-lineal-itim2101.png" />
	            ...
	            <div class="row">
	                <div class="col-md-4">
	                    <div class="boxWithIco">
	                        <div class="icoImg">
	                            <figure>
	                                <img src="images/termLoan-ico1.jpg" alt="">
	                            </figure>
	                        </div>

	                        <div class="content">
	                            <h4>Term Loan limit</h4>
	                            <p>Up to $1 million</p>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="boxWithIco">
	                        <div class="icoImg">
	                            <figure>
	                                <img src="images/termLoan-ico2.jpg" alt="">
	                            </figure>
	                        </div>

	                        <div class="content">
	                            <h4>Interest rate</h4>
	                            <p>9.95% - 19.95% annual percentage rate</p>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="boxWithIco">
	                        <div class="icoImg">
	                            <figure>
	                                <img src="images/termLoan-ico3.jpg" alt="">
	                            </figure>
	                        </div>

	                        <div class="content">
	                            <h4>Fees</h4>
	                            <p>No annual fee or establishment fee. No early repayment fees.</p>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="boxWithIco">
	                        <div class="icoImg">
	                            <figure>
	                                <img src="images/termLoan-ico4.jpg" alt="">
	                            </figure>
	                        </div>
	                ...
	                <div class="col-md-4">
	                    <div class="boxWithIco">
	                        <div class="icoImg">
	                            <figure>
	                                <img src="images/termLoan-ico5.jpg" alt="">
	                            </figure>
	                        </div>

	                        <div class="content">
	                            <h4>Minimum time in business</h4>
	                            <p>3 years+</p>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="boxWithIco">
	                        <div class="icoImg">
	                            <figure>
	                                <img src="images/termLoan-ico6.jpg" alt="">
	                            </figure>
	                        </div>

	                        <div class="content">
	                            <h4>Repayments</h4>
	                            <p>Weekly and monthly options.</p>
	                        </div>
	                    </div>
	                </div>
	            </div>
	...
	<section class="logosComp d-none">
	    <div class="container">
	        <h3>Partners we bring on board to your Business</h3>
	...
	<section class="location" style="padding-top: 60px;">
	    <div class="container">
	        <div class="boxTop">
	            <div class="row">
	                <div class="col-md-12">
